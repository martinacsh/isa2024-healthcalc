...
public interface HealthCalc {
	 ...
	 * For men: IW = height - 100 - (height - 150) / 4) For women: IW = height - 100
	 * - (height - 150) / 2.5)
	 *
	...
	/**
	 * Calculate the Basal Metabolic Rate (BMR) of a person with the following
	 * formula: For men: BMR = 10 * weight + 6.25 * height - 5 * age + 5 For women:
